package com.plusplusc.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.plusplusc.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.plusplusc.springboot.model" });
